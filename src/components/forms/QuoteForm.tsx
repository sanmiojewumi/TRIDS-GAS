...
import { Send, CheckCircle2, ShieldCheck, MessageCircle, AlertCircle } from 'lucide-react';
    ...
    <div className="glass-card rounded-3xl p-6 sm:p-8 md:p-10 border border-[#1E3A8A] shadow-2xl relative">
      ...
      {success ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="p-4 rounded-2xl bg-[#070D1E] border border-dashed border-[#1E3A8A] text-xs text-slate-300">
            <p className="flex items-center gap-2 font-semibold text-white mb-1">
              <MessageCircle className="w-4 h-4 text-emerald-400" />
              Photos or boiler fault codes?
            </p>
            <p>
