...
export const HeroSection: React.FC<HeroProps> = ({ settings }) => {
  return (
    <section className="relative min-h-0 lg:min-h-[82vh] flex items-center justify-center bg-[#070D1E] overflow-hidden pt-6 pb-12 sm:pb-16 lg:py-16">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3 bg-[#0F1C3F]/90 border border-[#1E3A8A] rounded-2xl p-2.5 px-4 shadow-xl">
          ...
          <div className="flex items-center gap-4 text-xs font-mono">
            <span className="hidden sm:flex items-center gap-1 text-yellow-400 font-bold">
              <Star className="w-3.5 h-3.5 fill-yellow-400" /> Gas Safe Registered • Locally Trusted
            </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              <Link
                href="/book"
                className="inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-gradient-to-r from-yellow-400 via-amber-500 to-amber-600 hover:from-yellow-300 hover:to-amber-500 text-slate-950 text-sm sm:text-base font-extrabold transition-all shadow-glow-gold hover:scale-[1.02] active:scale-95"
              >
              ...
              <Link
                href="/quote"
                className="inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-[#0F1C3F] hover:bg-[#142552] text-white text-sm sm:text-base font-bold border border-[#1E3A8A]"
              >
                Get a Quote
              </Link>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white text-sm sm:text-base font-bold transition-all border border-red-400/40 shadow-glow-red font-mono"
              >
