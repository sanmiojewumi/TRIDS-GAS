          ...
          <div className="flex items-center gap-3">
            ...
            <div className="bg-[#0F1C3F] border border-[#1E3A8A] p-3 rounded-2xl flex items-center gap-3">
              ...
              <div className="text-xs text-slate-300 font-medium">
                <span className="text-white font-bold">5.0 Star</span> Average Rating
              </div>
            </div>
            ...
            <div className="bg-[#0F1C3F] border border-[#1E3A8A] rounded-3xl p-6 max-w-md w-full relative shadow-2xl">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs transition-all shadow-glow-gold"
                  >
                    Submit Review
                  </button>
                </form>
