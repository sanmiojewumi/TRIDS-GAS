...
export const StatsRibbon: React.FC = () => {
  const stats = [
    ...
    },
    {
      ...
      value: 'Published Feedback',
      subtext: 'Only real published reviews are shown',
    },
    {
      icon: Clock,
      color: 'text-red-400',
      ...
      label: 'BOOKING HOURS',
      value: 'Weekday Appointments',
      subtext: 'Saturday mornings by arrangement',
    },
    {
      icon: MapPin,
      color: 'text-sky-400',
      ...
      value: '30 Miles from Crewe',
      subtext: 'Cheshire plus extra towns we cover',
    },
  ];
