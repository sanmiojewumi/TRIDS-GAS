...
export default function AdminLoginPage() {
  ...
  const [email, setEmail] = useState('admin@tridsgas.co.uk');
      ...
      <div className="max-w-md w-full glass-card p-8 rounded-3xl border border-slate-800 shadow-2xl space-y-6">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="p-3 bg-slate-900 rounded-xl border border-slate-800 text-[11px] text-slate-400 space-y-1 font-mono">
            ...
            <div>Email: <strong className="text-amber-400">admin@tridsgas.co.uk</strong></div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold text-xs transition-all shadow-glow-gold disabled:opacity-50"
          >
